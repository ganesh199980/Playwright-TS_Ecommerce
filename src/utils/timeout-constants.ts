/**
 * timeout-constants.ts: This module provides timeout constants that can be used to override various actions, 
 * conditional statements, and assertions in Playwright tests. 
 * Instead of hard coding the timeout, use these constants for better maintainability.
 */
...
/**
 * Timeout constant for larger actions/assertions, set to 30000 milliseconds (30 seconds).
 */
...
/**
 * Timeout constants specifically for Playwright's functions.
 */
